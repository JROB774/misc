...
#ifndef E_REM_PIO2_C__ /*/////////////////////////////////////////////////////*/
#define E_REM_PIO2_C__
...
GLOBAL const int32_t two_over_pi[]
{
...
STDDEF int32_t __ieee754_rem_pio2 (double x, double* y)
{
