...
set idir=-I ..\src\external -I ..\src\external\FT2 -I ..\src\external\AL -I ..\src\external\OGG
set ldir=
set defs=
set cflg=-Zc:__cplusplus -std:c++17 -nologo -Oi -MT -WX -W4 -Gm- -EHsc
set lflg=-opt:ref -incremental:no
set cwrn=-wd4100 -wd4505 -wd4189
set lwrn=-ignore:4099
set libs=SDL2main.lib SDL2.lib freetype.lib opengl32.lib openal32.lib dinput8.lib dxguid.lib user32.lib gdi32.lib winmm.lib imm32.lib ole32.lib oleaut32.lib shell32.lib version.lib uuid.lib advapi32.lib setupapi.lib comdlg32.lib shlwapi.lib setargv.obj libogg.lib libvorbis_static.lib libvorbisfile_static.lib
